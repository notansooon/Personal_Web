   ...
   */
   ...
   const handleSubmit = async (e) => {
    ...
    return (
        ...
        <Helmet>
           <meta charSet="utf-8"/>
           <title>Contact Us | Dataism Laboratory for Quantitative Finance</title>
           <meta name="description" content="Need to get in touch with us?Don't hesitate to use this form"/>
         ...
         <div class="w-full lg:w-1/2 xl:w-5/12 md:mx-auto sm:mx-auto px-4">
            <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
               <form method="POST" action="/send" onSubmit={handleSubmit}>
                  ...
                  <div>
                     <button
                        type="submit" class="w-full text-black  bg-primary rounded  border border-primary p-3 transition hover:bg-opacity-90"
                        >
                     Send Message
                     </button>
                  </div>
