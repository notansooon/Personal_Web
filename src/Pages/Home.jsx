            ...
            >
                ...
                >
                    ...
                    <div className="grid lg:grid-cols-3 gap-10 ">
                        <motion.div
                            className="relative flex items-end bg-cover bg-center bg-no-repeat h-[450px]"
                        ...
                        <motion.div
                            className="relative flex items-end bg-cover bg-center bg-no-repeat h-[360px]"
                        ...
                        <motion.div
                            className="relative flex items-end bg-cover bg-center bg-no-repeat h-[280px]"
                ...
                <motion.div
                    ...
                    variants={animationVariants}
                    transition={{ duration: 0.5 }}
                    className="relative mb-16 flex flex-col lg:flex-row bg-cover bg-center bg-no-repeat bg-gray-300 bg-opacity-75"
                    ...
                    <div className="contain">
                        <div className="content-container">
                            <div className="text-container">
                                ...
                                <div
                                    className="text-2xl mt-10 items-center justify-center flex flex-col border-b-4 pb-10">
