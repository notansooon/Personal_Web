    ...
    return (
        <Card color="transparent" className="items-center" shadow={false}>
            ...
            <CardBody className="flex flex-col items-center">
                <h5 className="mb-3 text-lg font-semibold text-blue-gray lg:text-xl">
                    {title}
                </h5>
                <p className="mb-4 text-center text-sm font-normal leading-relaxed text-gray-500 lg:text-base">
...
export function Sector() {
    return (
        <section
            ...
            className="lg:py-28 py-16 -mb-24 px-8 w-screen"
        >
            <div className="container mx-auto mb-24 text-center">
                <h2 className="mb-4 text-2xl font-bold text-blue-gray lg:text-4xl">
                    Sectors
                </h2>
                <p className="mx-auto max-w-xl text-lg text-gray-500 lg:text-xl">
